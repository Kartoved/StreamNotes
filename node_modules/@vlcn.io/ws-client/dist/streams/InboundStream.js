import { bytesToHex, tags, greaterThanOrEqual, } from "@vlcn.io/ws-common";
/**
...
export default class InboundStream {
    ...
    receiveChanges = async (msg) => {
        ...
        const newLastSeen = [lastChange[5], 0];
        this.#lastSeens.set(senderHex, newLastSeen);
        try {
            await this.#db.applyChangesetAndSetLastSeen(msg.changes, msg.sender, newLastSeen);
        }
        catch (e) {
...
//# sourceMappingURL=InboundStream.js.map