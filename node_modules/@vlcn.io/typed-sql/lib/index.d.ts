...
export type Record<P, K extends P extends SchemaType<infer T> ? keyof T : never> = P extends SchemaType<infer T> ? T[K extends keyof T ? K : never] : never;
export type Records<P> = P extends SchemaType<infer T> ? T : never;
export declare function schema<TSchema>(strings: TemplateStringsArray, ...values: any[]): SchemaType<TSchema>;
export {};
