...
export class TblRx {
    ...
    #arbitraryListeners = new Set();
    __internalRawListener = () => { };
    #disposeHook;
    ...
    constructor(db) {
        ...
        this.#disposeHook = this.db.onUpdate((updateType, dbName, tblName, rowid) => {
     ...
     */
    __internalNotifyListeners(data, src) {
    ...
    #preNotify(updateType, tbl, rowid) {
...
export default function tblrx(db) {
    return new TblRx(db);
}
//# sourceMappingURL=tblrx.js.map