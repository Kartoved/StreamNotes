    ...
    switch (tag) {
        case tags.AnnouncePresence:
            return {
                ...
                lastSeens: Array.from({ length: decoding.readVarUint(decoder) }).map((_) => {
                    return [
        ...
        case tags.StartStreaming:
            return {
                ...
                since: [decoding.readBigInt64(decoder), decoding.readVarInt(decoder)],
                excludeSites: Array.from({ length: decoding.readVarUint(decoder) }).map((_) => {
