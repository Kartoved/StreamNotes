...
function writeAnnouncePresenceSansTag(encoder, msg) {
    encoding.writeUint8Array(encoder, msg.sender);
...
function writeChangesMsgSansTag(encoder, msg) {
    encoding.writeUint8Array(encoder, msg.sender);
    encoding.writeBigInt64(encoder, BigInt(msg.since[0]));
    encoding.writeVarInt(encoder, Number(msg.since[1]));
    writeChanges(encoder, msg.changes);
...
export const BOOL = 4;
export const BLOB = 5;
function writeChanges(encoder, changes) {
...
function writeValue(encoder, value) {
