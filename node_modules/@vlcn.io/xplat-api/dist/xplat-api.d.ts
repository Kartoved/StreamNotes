...
export declare function cryb64(str: string, seed?: number): bigint;
export declare function first<T>(data: T[]): T | undefined;
export declare function firstPick<T>(data: any[]): T | undefined;
export declare function pick<T extends any, R>(data: T[]): R[];
