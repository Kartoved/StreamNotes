      ...
      >
        ...
        <div style={{
          ...
          <div style={{ display: 'flex', alignItems: 'baseline', gap: '8px' }}>
            <span style={{ fontSize: '1.6rem', fontWeight: 700, fontFamily: 'var(--font-mono)', color: 'var(--text)', display: 'inline-flex', alignItems: 'center', gap: '10px' }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '2px', fontSize: '0.72rem', color: 'var(--text-sub)', fontFamily: 'var(--font-mono)' }}>
            ...
            <span style={{ display: 'inline-flex', alignItems: 'center', gap: '6px' }}>
              <FreezeCrystal size={11} active={streak.state.freezes > 0} />
              заморозок: <strong style={{ color: 'var(--text)' }}>{streak.state.freezes}/{MAX_FREEZES}</strong>
              <span style={{ color: 'var(--text-faint)' }}>(+1 каждые 7 дн.)</span>
            </span>
          </div>
